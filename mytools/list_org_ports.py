...
@tool("get_org_ports", return_direct=True)
def get_org_ports():
    """Returns all List the switchports in an organization"""
    url = f"{BASE_URL}/organizations/{ORGANIZATION_ID}/switch/ports/statuses/bySwitch"
